# -*- coding: utf-8 -*-
"""
Created on Sun Oct 23 17:09:34 2016

Don't modify this script.

This is an example script from the aubio library showing the raw audio 
waveform for a given audio file. This is a useful tool for visualizing 
audio data.

Example usage:

    python demo_waveform_plot.py data/eric.mp3
