# -*- coding: utf-8 -*-
"""
Created on Sun Oct 23 17:06:30 2016

Don't modify this script.

This is an example script from the aubio library showing the pitch contour 
and confidence curves of a given audio file. It is a useful tool for 
visualizing pitch.

Example usage:

    python visualize_pitch.py data/eric.mp3
...
pitch_o.set_unit("midi") # midi pitch is in the range [0, 127]
